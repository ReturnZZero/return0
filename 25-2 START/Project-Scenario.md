...
| 사용할 소프트웨어 패키지의 명칭과 URL | 생성형 AI 모델 : GPT-5 (https://openai.com/)<br>지도 플러그인 : google maps flutter (https://pub.dev/packages/google_maps_flutter)<br>지도 플러그인 : kakao_map_plugin (https://pub.dev/packages/kakao_map_plugin
) |
