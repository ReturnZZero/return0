...
1. 프로젝트 주제 및 제목
		...
		기획 목적: 반려동물 동반 여행 수요가 증가하는 가운데, 기존 여행 서비스는 반려동물 친화적인 장소 및 일정 추천에 한계가 있습니다. 본 프로젝트는 AI 추천 시스템과 위치 기반 서비스를 결합하여, 반려인에게 맞춤형 여행 일정을 제공하고, 반려동물 친화 공간 탐색 및 커뮤니티 기반 후기 공유 기능을 지원하는 모바일 애플리케이션을 개발하는 것을 목적으로 합니다.
